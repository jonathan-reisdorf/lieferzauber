module.exports = {
  ...
  'ADDRESS.SAVE' : 'Save',
  'CATEGORY.INTRO_TEXT' : 'What would you like to eat?',
  'CATEGORY.FAST-FOOD' : 'Fast Food',
  'CATEGORY.PIZZA' : 'Pizza',
  'CATEGORY.SUSHI' : 'Sushi',
  'CATEGORY.MEDITERRAN' : 'Mediterranean',
  'CATEGORY.ORIENTAL' : 'Oriental',
  'CATEGORY.ASIAN' : 'Asian',
  'CATEGORY.INTERNATIONAL' : 'International',
  'CATEGORY.INDIAN' : 'Indian',
  'CATEGORY.GOURMET' : 'Gourmet',
  'PEOPLE.INTRO_TEXT' : 'How many hungry people want to be saturated?',
  'ERROR.NO_RESTAURANT_FOUND' : 'Unfortunately within this category, for your surrounding and for the chosen number of hungry people there are no restaurants with reasonable offers at this moment! :(',
  ...
  'SELECTION.YOUR_ACTION.RAISE' : 'That\'s to cheap. More expensive, please!',
  'ORDER.CONFIRM' : 'Disclaimer: Are you really sure, that, without knowing what you will get, you want to spend the amount of %% €? Theoretically everything is possible. Instead of a meal you could for example just get three drinks. Or a burger with nutella. It\'s not likely, but also not impossible! Also you should ensure that you and none of your friends is allergic to specific ingredients. In each and every case the order is done at your own risk. You\'ll however receive an email that most probably also contains a list of the order items. If you keep on the edge of seat you can of course look at the list and maybe call the delivery service for change requests.',
